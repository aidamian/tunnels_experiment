"""Helpers for operator-facing app-side logs emitted through the Ratio1 SDK logger."""
...
try:
  ...
  raise SystemExit("missing host dependency. Install the Ratio1 SDK for app-side Python utilities.") from exc
...
def build_console_logger(scope: str) -> Logger:
  """Return a quiet SDK logger for app-side console status updates."""
